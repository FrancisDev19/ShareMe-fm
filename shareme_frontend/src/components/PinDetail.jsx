...
const PinDetail = ({ user }) => {
  ...
  if (!pinDetail) return <Spinner massage="Loading pins" />;

  return (
    <>
      <div
        className="flex xl:flex-row flex-col m-auto shadow-lg p-2"
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          ...
          <div className="flex flex-wrap mt-6 gap-3">
            ...
            <input
              ...
              className="text-slate-900 flex-1 border-gray-100 outline-none border-2 p-2 rounded-2xl focus:border-gray-300"
            />
            <button
              type="button"
